    ...
    const onSubmit = async (data) => {
        try {
            if (!data) {
                ...
                const add = await CategoryAPI.add(data);
                        ...
                        <div className="container-fluid">
                            ...
                            <div className="">
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    <input type="text" placeholder={Category.name} {...register("name", { required: true })} />
                                    {errors.name && <span>Tên danh mục không được để trống</span>}
                                    <button>Thêm</button>
                                </form>
                            </div>
                        </div>
