...
const ProductAdmin = () => {
    ...
    const onHandleRemove = async (id) => {
        try {
            ...
            console.log(data)
            const newProduct = product.filter(item => item._id !== data.remove._id)
                ...
                <div id="content-wrapper" className="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div className="container-fluid">
                            ...
                            <div className="">
                                <Link className="btn btn-primary" to="/admin/product/add"> Them Moi</Link>
                            </div>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    {product.map((item, index) =>
                                        <tr key={index}>
                                            ...
                                            <td>{item.name}</td>
                                            <td><img src={item.images} width="268.85px" height="201.64px" /></td>
                                            <td>{item.price}</td>
                                            <td>{item.category.name}</td>
                                            <td>
                                                <button type="button" confirm="Ban co chac chan muon xoa" onClick={() => onHandleRemove(item._id)} class="btn btn-danger ml-2">Xóa</button>
                                                <Link className="btn btn-warning" to={`${item._id}/edit`}> sửa</Link>
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
